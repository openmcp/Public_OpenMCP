...
func main() {
	...
	*/
	...
	node_found := &corev1.Node{}
	err := cm.Host_client.Get(context.TODO(), node_found, "", "openmcp-master")
	...
	if err != nil && errors.IsNotFound(err) {
		...
		fmt.Println(node_found.Status.Addresses[0].Address)
		openmcpIP = node_found.Status.Addresses[0].Address
	}
