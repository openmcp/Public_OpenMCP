...
require (
	...
	github.com/HanJaeseung/LoadBalancing v0.0.0-20200514080219-4dde442ca279
...
replace (
	github.com/HanJaeseung/LoadBalancing v0.0.0-20200414055331-6706ccef3f09 => ./HanJaeseung/LoadBalancing
