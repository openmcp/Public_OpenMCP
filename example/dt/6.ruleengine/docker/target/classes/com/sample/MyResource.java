...
public class MyResource {
    ...
    String time;
    HashMap<String, HashMap<String, String>> nodeDataMap = new HashMap();
    ...
    public void setNodeDataMap(HashMap<String, HashMap<String, String>> nodeDataMap){
        this.nodeDataMap = nodeDataMap;
    }
    public HashMap<String, HashMap<String, String>> getNodeDataMap(){
