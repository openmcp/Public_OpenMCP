...
class SetThreshold extends Component {
  constructor(props) {
    ...
    this.state = {
      columns: [
        ...
        { name: "cpu_warn", title: "CPU(W)" },
        { name: "cpu_danger", title: "CPU(D)" },
        { name: "ram_warn", title: "Ram(W)" },
      ...
      defaultColumnWidths: [
        ...
        { columnName: "cpu_warn", width: 120 },
        { columnName: "cpu_danger", width: 120 },
        { columnName: "ram_warn", width: 120 },
        { columnName: "ram_danger", width: 120 },
        { columnName: "storage_warn", width: 130 },
        { columnName: "storage_danger", width: 130 },
        { columnName: "created_time", width: 180 },
        { columnName: "updated_time", width: 180 },
      ],
  ...
  render() {
    ...
    const Cell = (props) => {
      ...
      if (
        column.name === "cpu_warn" ||
        column.name === "ram_warn" ||
        column.name === "storage_warn"
      ) {
        return (
          <Table.Cell
            {...props}
        ...
        column.name === "cpu_danger" ||
        column.name === "ram_danger" ||
        column.name === "storage_danger"
      ) {
        return (
          <Table.Cell
            {...props}
