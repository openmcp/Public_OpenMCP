...
import (
	...
	"openmcpscheduler/pkg/controller/framework/plugins/priorities"
)
...
func NewFramework() OpenmcpFramework{
	klog.Info("[YENA] Create NewFramework...")

	f := &openmcpFramework{
		// filterPlugins:		make([]OpenmcpFilterPlugin, 0),
		filterPlugins: []OpenmcpFilterPlugin{
		...
		// scorePlugins:		make([]OpenmcpScorePlugin, 0),
		scorePlugins: []OpenmcpScorePlugin{
