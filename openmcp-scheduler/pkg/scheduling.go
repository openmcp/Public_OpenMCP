...
func (sched *OpenMCPScheduler) Scheduling (cm *clusterManager.ClusterManager, dep *ketiv1alpha1.OpenMCPDeployment) map[string]int32 {
	...
	omcplog.V(0).Infof("=> Scheduling Result : ", totalSchedulingResult)
