...
var (
	...
	apiGroup = map[string]string {
		...
		"openmcpdeployments": "/apis/keti.example.com/v1alpha1",
		"openmcpservices": "/apis/keti.example.com/v1alpha1",
		"openmcpingresss": "/apis/keti.example.com/v1alpha1",
		"openmcphybridautoscalers": "/apis/keti.example.com/v1alpha1",
		"openmcppolicys": "/apis/keti.example.com/v1alpha1",
		"openmcpconfigmaps": "/apis/keti.example.com/v1alpha1",
		"openmcpsecrets": "/apis/keti.example.com/v1alpha1",
