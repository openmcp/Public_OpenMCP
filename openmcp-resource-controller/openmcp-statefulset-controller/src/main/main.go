...
import (
	...
	openmcpstatefulset "openmcp/openmcp/openmcp-resource-controller/openmcp-statefulset-controller/src/controller"
...
func main() {
	...
	co, err_co := openmcpstatefulset.NewController(live, ghosts, namespace, cm)
	if err_co != nil {
