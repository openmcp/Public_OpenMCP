...
import (
	...
	openmcppvc "openmcp/openmcp/openmcp-resource-controller/openmcp-pvc-controller/src/controller"
...
func main() {
	...
	co, err_co := openmcppvc.NewController(live, ghosts, namespace, cm)
	if err_co != nil {
