...
import (
	...
	openmcpjob "openmcp/openmcp/openmcp-resource-controller/openmcp-job-controller/src/controller"
...
func main() {
	...
	co, err_co := openmcpjob.NewController(live, ghosts, namespace, cm)
	if err_co != nil {
