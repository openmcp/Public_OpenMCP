...
import (
	...
	openmcphas "openmcp/openmcp/openmcp-resource-controller/openmcp-has-controller/src/controller"
...
func main() {
	...
	co, err_co := openmcphas.NewController(live, ghosts, namespace, cm)
	if err_co != nil {
