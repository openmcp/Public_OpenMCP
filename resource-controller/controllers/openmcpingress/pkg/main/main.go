...
import (
	...
	"resource-controller/controllers/openmcpingress/pkg/controller"
...
func main() {
	...
	/*
	   	...
	   	co, _ := openmcpingress.NewController(live, ghosts, ghostNamespaces)
	...
	*/
	...
	cm := openmcpingress.NewClusterManager()
