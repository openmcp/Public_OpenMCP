...
kubectl delete ingress example-openmcpingress-ingress -n openmcp
kubectl delete ingress example-openmcpingress-ingress --context cluster1 -n openmcp
kubectl delete ingress example-openmcpingress-ingress --context cluster2 -n openmcp
kubectl delete ingress example-openmcpingress-ingress --context cluster3 -n openmcp
